...
def by_location(test_filename):
    ...
    for j,i in enumerate(data['Lng']):
        ...
        url = 'http://api.openweathermap.org/data/2.5/weather?lat={}&lon={}&appid=81f5a3465ec3abf5ce734c45ef519ef4&units=metric'.format(data['Lat'].values[j], data['Lng'].values[j])
