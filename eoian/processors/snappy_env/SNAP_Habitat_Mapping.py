...
def randomforestmodel(Output,resampled_product):
    ...
    classifierParameters.put('featureBands', ','.join([resampled_product_4.getBandAt(0).getName(),resampled_product_4.getBandAt(1).getName(),resampled_product_4.getBandAt(2).getName(),resampled_product_4.getBandAt(3).getName(),resampled_product_4.getBandAt(4).getName(),resampled_product_4.getBandAt(5).getName(),resampled_product_4.getBandAt(6).getName(),resampled_product_4.getBandAt(7).getName(),resampled_product_4.getBandAt(8).getName(),resampled_product_4.getBandAt(9).getName(),resampled_product_4.getBandAt(10).getName(),resampled_product_4.getBandAt(11).getName()]))
